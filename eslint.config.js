...
export default ts.config(
	...
	},
	{
		languageOptions: {
			parserOptions: {
				project: './tsconfig.base.json', // Path to TypeScript config file
				tsconfigRootDir: import.meta.dirname, // Ensures correct directory resolution
				extraFileExtensions: ['.svelte'] // Ensures ESLint recognizes `.svelte` TypeScript files
			}
		}
	},
	{
	...
	},
	{
		rules: {
			...
			'svelte/consistent-selector-style': ['warn'] // Enforce a consistent, lowercase style for CSS selectors
		}
	}
);
